        ...
        <CardBody p={6}>
          <Flex direction={{ base: "column", md: "row" }} align="center" justify="space-between">
            <HStack spacing={6}>
              ...
              />
              <Box>
                <Text fontSize="lg" fontWeight="bold" color="#162D5D">
            ...
            <HStack spacing={6} mt={{ base: 4, md: 0 }}>
              ...
              <VStack spacing={1} align="center">
                <Badge colorScheme="blue" fontSize="sm" px={3} py={1}>
                  {doctorDetails?.total_appointment_done}
                </Badge>
                <Text fontSize="xs" color="gray.500">Appointments</Text>
              </VStack>
              <VStack spacing={1} align="center">
                <Badge 
                  colorScheme={doctorDetails?.active === 1 ? "green" : "red"} 
                  fontSize="sm" 
                  px={3} 
                  py={1}
                >
                  {doctorDetails?.active === 1 ? "Active" : "Inactive"}
                </Badge>
